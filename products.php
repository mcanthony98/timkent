...
if(isset($_GET['query'])){
    ...
    $pqry = "SELECT * FROM product JOIN category ON product.category_id=category.category_id WHERE product.name LIKE '%$query%' OR product.description LIKE '%$query%' OR  product.slug LIKE '%$query%' OR category.category_name LIKE '%$query%'";
  
}elseif(isset($_GET['category'])){
    $query = $_GET['category'];
    $title = "Search results for '".$_GET["query"]."'";
    $pqry = "SELECT * FROM product JOIN category ON product.category_id=category.category_id WHERE category.category_id = '$query'";
}else{
    $title = "All Products";
    $query = "All products";
    $pqry = "SELECT * FROM product JOIN category ON product.category_id=category.category_id ORDER BY product.product_id DESC";
}
...
<head>
    ...
    <title><?php echo $title;?> - Timkent Spareparts</title>
